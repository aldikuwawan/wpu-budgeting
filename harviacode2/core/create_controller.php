...
$string .= "\n\n    public function index()
    {
        ...
        \$this->template->load('$c_url/$v_list', \$data);
    }";
...
$string .="\n\n    public function index()
    {
        \$this->template->load('$c_url/$v_list');
    } 
...
$string .= "\n\t    );
            \$this->template->load('$c_url/$v_read', \$data);
        } else {
...
$string .= "\n\t);
        \$this->template->load('$c_url/$v_form', \$data);
    }
...
if ($export_word == '1') {
    $string .= "\n\n    public function word()
    {
        ...
        \$this->template->load('" . $c_url ."/". $v_doc . "',\$data);
    }";
}
...
if ($export_pdf == '1') {
    $string .= "\n\n    function pdf()
    {
        ...
        \$html = \$this->template->load('" . $c_url ."/". $v_pdf . "', \$data, true);
